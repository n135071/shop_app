            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      if (productsBloc.favoriteLists
                          .contains(productsBloc.productLists[index])) {
                        productsBloc.add(RemoveFromFavorite(
                            prudact: productsBloc.productLists[index]));
                      } else {
                        productsBloc.add(AddToFavorite(
                            prudact: productsBloc.productLists[index]));
                      }
                    },
                    icon: Icon(
                      Icons.favorite_border,
                      color: productsBloc.favoriteLists
                              .contains(productsBloc.productLists[index])
                          ? Colors.red
                          : Colors.black,
                    ),
